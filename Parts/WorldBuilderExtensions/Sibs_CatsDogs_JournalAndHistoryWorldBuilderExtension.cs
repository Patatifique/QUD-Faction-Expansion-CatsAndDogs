...
namespace Sibs.CatsAndDogs
{
    ...
    public class Sibs_CatsDogs_JournalAndHistoryWorldBuilderExtension : IJoppaWorldBuilderExtension
    {
        public override void OnAfterBuild(JoppaWorldBuilder builder)
        {
            ...
            JournalAPI.AddObservation(
                ...
                "$Sibs_CatsDogs_ShiksparFounder_Cat", 
                "Gossip", 
                "$Sibs_CatsDogs_ShiksparFounder_Cat",
                new string[]
                {
            ...
            JournalAPI.AddObservation(
                ...
                "$Sibs_CatsDogs_ShiksparFounder_Dog",
                "Gossip",
                "$Sibs_CatsDogs_ShiksparFounder_Dog",
                new string[]
                {
